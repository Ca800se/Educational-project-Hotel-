...
namespace autic
{
    public partial class addnumbers : UserControl
    {
        ...
        private void addnumbers_Load(object sender, EventArgs e)
        {
            сreatecolum();
        ...
        private void delnumber_Click_1(object sender, EventArgs e)
        {
            daletedRow();
        }
